                                            ...
                                            <Form onSubmit={submit}>
                                                <div className='mb-3'>
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        value={data.username}
                                                        className={'mb-1 ' + (errors.username ? 'is-invalid' : ' ')}
                                                    ...
                                                    <Form.Control.Feedback type="invalid" className='d-block mt-2'> {errors.username} </Form.Control.Feedback>
                                                </div>
