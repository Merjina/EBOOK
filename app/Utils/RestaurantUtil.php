    ...
    public function getBookingsForCalendar($filters)
    {
        ...
        foreach ($bookings as $booking) {
            ...
            $events[] = [
                ...
                'table' => $table_name,
                'url' => action([\App\Models\Http\Controllers\Restaurant\BookingController::class, 'show'], [$booking->id]),
                'event_url' => action([\App\Models\Http\Controllers\Restaurant\BookingController::class, 'index']),
