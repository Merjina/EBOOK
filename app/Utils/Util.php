...
class Util
{
    ...
    public function parseNotifications($notifications)
    {
        ...
        foreach ($notifications as $notification) {
            ...
            if (in_array($notification->type, [\App\Models\Notifications\RecurringInvoiceNotification::class, \App\Models\Notifications\RecurringExpenseNotification::class])) {
                $msg = '';
                $icon_class = '';
                $link = '';
                if (
                    $notification->type ==
                    \App\Models\Notifications\RecurringInvoiceNotification::class
                ) {
                    ...
                    $link = action([\App\Models\Http\Controllers\SellPosController::class, 'listSubscriptions']);
                } elseif (
                    $notification->type ==
                    \App\Models\Notifications\RecurringExpenseNotification::class
                ) {
                    $msg = __(
                    ...
                    $link = action([\App\Models\Http\Controllers\ExpenseController::class, 'index']);
                }
                ...
                $moduleUtil = new \App\Models\Utils\ModuleUtil;
    ...
    public function createUser($request)
    {
        ...
        if ($user_details['user_type'] == 'user') {
            ...
            if (! $moduleUtil->isSubscribed($business_id)) {
                ...
                return $moduleUtil->quotaExpiredResponse('users', $business_id, action([\App\Models\Http\Controllers\ManageUserController::class, 'index']));
            }
        }
